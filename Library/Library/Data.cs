...
namespace Library
{
    public class Data
    {
        ...
        public Data()
        {
            objectTypes = Assembly.GetExecutingAssembly().GetTypes().
                Where(t => !t.IsAbstract).Where(t => t.GetInterface(typeof(IBaseObject).ToString()) != null).ToList<Type>();
            serializerTypes = Assembly.GetExecutingAssembly().GetTypes().
                Where(t => !t.IsAbstract).Where(t => t.GetInterface(typeof(IBaseSerializer).ToString()) != null).ToList<Type>();
